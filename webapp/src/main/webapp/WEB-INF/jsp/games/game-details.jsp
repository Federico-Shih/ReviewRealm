...
<body>
        ...
        <div class="game-review-section">
            <div class="game-review-header">
                <span class="review-header">Reseñas de otros usuarios</span>
            </div>
            <div class="review-card-list">
                ...
                <span id="review-card-bottom-text"> por <span id="review-card-author">@<c:out value="${review.author.email}"/></span>, quien prefiere: </span>
