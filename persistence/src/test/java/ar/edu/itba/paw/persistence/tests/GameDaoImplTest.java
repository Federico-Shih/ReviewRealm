...
public class GameDaoImplTest {
    ...
    private Long userSetUp(){
        ...
        Long userId  = jdbcInsertForUsers.executeAndReturnKey(args).longValue();
    ...
    private Long reviewSetUp(Long userId,Long gameId,Integer rating){
        ...
        return jdbcInsertForReviews.executeAndReturnKey(args).longValue();
    }

    private Long insertGame(Boolean suggested, Integer ratingSum, Integer reviewCount){
        Map<String,Object> args = new HashMap<>();
        args.put("name",NAME);
        ...
        return insertForGames.executeAndReturnKey(args).longValue();
    }
    @Test
    public void testFindByIdNoGenres(){
        //Setup game
        Long gameId = insertGame(SUGGESTED,0,0);
    ...
    public void testCreateWithGenres(){
        ...
        List<Game> games = jdbcTemplate.query("SELECT * FROM games",CommonRowMappers.GAME_ROW_MAPPER);
    ...
    public void testAddNewReview(){
        Long gameId = insertGame(SUGGESTED,10,2);
        ...
        Assert.assertEquals(Double.valueOf((10.0+7.0)/3.0),game.getAverageRating());
    ...
    public void testDeleteReview(){
        Long gameId = insertGame(SUGGESTED,15,3);
    ...
    public void testSetSuggestedFalse(){
        Long gameId = insertGame(true,15,3);
    ...
    public void testReplaceAllFavoriteGames(){
        ...
        Long gameId1 = insertGame(SUGGESTED,0,0);
        Long gameId2 = insertGame(SUGGESTED,0,0);
        Long gameId3 = insertGame(SUGGESTED,0,0);
    ...
    public void testGetFavoriteGamesCandidates(){
        ...
        Long gameId1 = insertGame(SUGGESTED,0,0);
        Long gameId2 = insertGame(SUGGESTED,0,0);
        Long reviewId1 = reviewSetUp(userId,gameId1,8);
    ...
    public void testGetFavoriteGamesCandidatesEmpty(){
        ...
        Long gameId1 = insertGame(SUGGESTED,0,0);
        Long gameId2 = insertGame(SUGGESTED,0,0);
        Long reviewId1 = reviewSetUp(userId,gameId1,5);
        Long reviewId2 = reviewSetUp(userId,gameId2,3);
    ...
    public void testFindAllNoFiltersAverageRatingOrdering(){
        Long gameId1 = insertGame(SUGGESTED,10,1);
        Long gameId2 = insertGame(SUGGESTED,5,2);
        ...
        Game game1 = games.stream().findFirst().get();
    ...
    public void testFindAllSearch(){
        Long gameId1 = insertGame(SUGGESTED,10,1);
        Long gameId2 = insertGame(SUGGESTED,5,2);
        Long gameId3 = insertGame(SUGGESTED,3,3);
    ...
    public void testFindAllRatingRange(){
        Long gameId1 = insertGame(SUGGESTED,10,1);
        Long gameId2 = insertGame(SUGGESTED,16,2);
        Long gameId3 = insertGame(SUGGESTED,3,3);
    ...
    public void testFindAllRatingRangeEmpty(){
        Long gameId1 = insertGame(SUGGESTED,17,2);
        Long gameId2 = insertGame(SUGGESTED,16,2);
        Long gameId3 = insertGame(SUGGESTED,3,3);
    ...
    public void testGetGamesReviewdByUser(){
        Long gameId = insertGame(SUGGESTED,0,0);
        Long userId = userSetUp();
        Long reviewid = reviewSetUp(userId,gameId,1);

        Set<Game> games = gameDao.getGamesReviewdByUser(userId);
