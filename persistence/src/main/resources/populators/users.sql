...
VALUES (1, 'username1', 'email', 'password');
INSERT INTO users (id, username, email, password)
VALUES (2, 'username2', 'email2', 'password');
INSERT INTO users (id, username, email, password)
VALUES (3, 'aaaa', 'email3', 'password');
INSERT INTO users (id, username, email, password)
VALUES (4, 'bbbb', 'email4', 'password');
INSERT INTO users (id, username, email, password, enabled, reputation, avatar, language, xp)
VALUES (5, 'ab', 'email5', 'password', 1, 100, 1, 'en', 100);
