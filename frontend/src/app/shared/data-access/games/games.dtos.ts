...
export type GameSearchDto = Partial<
  GameFiltersDto & PaginatedDto & SortedDto<GameSortType>
>;

export type GameNotReviewedBySearchDto = Partial<
  GameNotReviewedByFilterDto & PaginatedDto & SortedDto<GameSortType>
>;

export type GameExclusiveSearchDto = Partial<
  (GameRecommendedFilterDto | GameFavoriteFilterDto) & PaginatedDto
>;
