...
const routes: Routes = [
  ...
  {path: 'submit/search', component: ReviewSubmitSearchComponent, canActivate: [isAuthenticatedGuard]},
  {path: 'submit/:game_id', component: ReviewSubmitComponent, canActivate: [isAuthenticatedGuard]},
  {path: ':id/edit', component: ReviewEditComponent, canActivate: [isReviewAuthorGuard]},
];
