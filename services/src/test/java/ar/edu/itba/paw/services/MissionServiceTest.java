...
public class MissionServiceTest {
    ...
    public void testNewMissionProgress() {
        ...
        MissionProgress missionProgress = missionService.addMissionProgress(user, Mission.ACCEPTED_GAMES, 1f);
    ...
    public void missionCompletedResetedProgress() {
        ...
        MissionProgress missionProgress = missionService.addMissionProgress(user, Mission.REVIEWS_GOAL, 1f);
